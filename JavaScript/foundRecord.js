...
async function fetchLostAndFoundRecords() {
    ...
    try {
        ...
        if (querySnapshot.empty) {
            tableBody.innerHTML = "<tr><td colspan='7' class='text-center text-muted'>No records available</td></tr>";
            return;
        }
        ...
        querySnapshot.forEach((doc) => {
            ...
            const row = `
                <tr>
                    ...
                    <td><img src="${data.image_url || "N/A"}" alt="Image" width="75" height="75"></td>
